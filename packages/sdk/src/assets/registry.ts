 ...
 *
 * V2 fields only. Assets that have not yet published V2 interfaces per
 * CIP-0112 §5 are not eligible for the registry.
 */
export interface AssetConfig {
  ...
  /** V2 instrument id (CIP-56 V2). Required. */
   ...
   * committed + iterated allocations). Required `true` — V2-only library.
   */
